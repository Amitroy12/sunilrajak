...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("==================================================================")
        print("                BOMBING in Amit progress, please wait !!               ")
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen(
            "https://raw.githubusercontent.com/Amit/TBomb/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/AmitX/TBomb/master/.notify").read().decode('utf-8')
